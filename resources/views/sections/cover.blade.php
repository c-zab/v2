<div id="cover" class="container-fluid px-0">
	<picture>
		...
		<source media="(max-width: 1299px)" type="image/webp" srcset="/images/coverBg-1024w.webp" />
		<source media="(max-width: 1299px)" type="image/png" srcset="/images/coverBg-1024w.png" />
		<source media="(min-width: 1300px)" type="image/webp" srcset="/images/coverBg-1300w.webp" />
		<source media="(min-width: 1300px)" type="image/png" srcset="/images/coverBg-1300w.png" />
		<img src="/images/coverBg-1300w.webp" type="image/webp" alt="placeholder" class="img-fluid cover-image" />
	</picture>
