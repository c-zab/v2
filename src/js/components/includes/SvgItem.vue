<template functional>
  ...
  <svg
    v-else-if="props.name === 'webpack'"
    class="maxWidth"
    viewBox="0 0 128 128"
    :aria-label="props.altText"
  >
    <g id="original-webpack"><path fill="#8ed6fb" d="M117.29,98.1,66.24,127V104.49L98,87,117.29,98.1Zm3.5-3.16V34.55L102.11,45.35V84.16l18.67,10.77ZM10.71,98.1l51,28.88V104.49L29.94,87Zm-3.5-3.16V34.55L25.89,45.35V84.16Zm2.19-64.3L61.76,1V22.76L28.21,41.21l-.27.15Zm109.18,0L66.24,1V22.76L99.79,41.2l.27.15,18.54-10.71Z" /><path fill="#1c78c0" d="M61.76,99.37,30.37,82.1V47.92L61.76,66Zm4.48,0L97.63,82.12V47.92L66.24,66ZM32.5,44,64,26.66,95.5,44,64,62.16,32.5,44Z" /></g>
  </svg>
  <svg
    v-else-if="props.name === 'chrome'"
    class="maxWidth"
    viewBox="0 0 128 128"
    :aria-label="props.altText"
  >
    <circle
      ...
      cy="64.236"
      r="60.999"
    /><path fill-opacity=".1" d="M102.966 75.327c0-21.439-17.379-38.819-38.817-38.819s-38.818 17.38-38.818 38.819h11.09c0-15.314 12.415-27.727 27.727-27.727 15.313 0 27.727 12.413 27.727 27.727" /><circle
      fill-opacity=".1"
      cx="66.922"
      cy="71.999"
      r="21.072"
    ...
    ><stop offset="0" stop-color="#81B4E0" /><stop offset="1" stop-color="#0C5A94" /></linearGradient><circle
      fill="url(#a)"
      cx="64.149"
      cy="64.235"
      r="22.736"
    ...
    ><stop offset="0" stop-color="#F06B59" /><stop offset="1" stop-color="#DF2227" /></linearGradient><path fill="url(#b)" d="M119.602 36.508c-15.266-30.716-52.542-43.24-83.259-27.974-9.578 4.761-17.764 11.913-23.765 20.766l24.955 43.253c-4.597-14.606 3.521-30.174 18.127-34.77 2.567-.808 5.243-1.238 7.935-1.274" /><linearGradient
      id="c"
      gradientUnits="userSpaceOnUse"
      x1="-657.835"
      y1="-491.393"
      ...
      y2="-533.537"
      gradientTransform="translate(675 599.775)"
    ><stop offset="0" stop-color="#388B41" /><stop offset="1" stop-color="#4CB749" /></linearGradient><path fill="url(#c)" d="M12.578 29.3c-19.1 28.492-11.486 67.071 17.005 86.171 8.814 5.909 18.997 9.461 29.575 10.319l26.063-44.363c-9.745 11.811-27.22 13.486-39.032 3.74-4.011-3.309-7.012-7.679-8.657-12.613" /><linearGradient
      id="d"
      gradientUnits="userSpaceOnUse"
      x1="-572.385"
      y1="-486.91"
      ...
      y2="-552.345"
      gradientTransform="translate(675 599.775)"
    ><stop offset="0" stop-color="#E4B022" /><stop offset=".3" stop-color="#FCD209" /></linearGradient><path fill="url(#d)" d="M59.158 125.791c34.204 2.585 64.027-23.047 66.613-57.25.834-11.037-1.295-22.093-6.17-32.031h-56.006c15.312.07 27.67 12.541 27.598 27.854-.028 6.195-2.131 12.204-5.972 17.064" /><linearGradient
      id="e"
      gradientUnits="userSpaceOnUse"
      x1="-649.391"
      y1="-528.885"
      ...
      y2="-573.247"
      gradientTransform="translate(675 599.775)"
    ><stop offset="0" stop-opacity=".15" /><stop offset=".3" stop-opacity=".06" /><stop offset="1" stop-opacity=".03" /></linearGradient><path fill="url(#e)" d="M12.578 29.3l24.955 43.253c-1.849-6.221-1.457-12.893 1.107-18.854l-24.954-26.063" /><linearGradient
      id="f"
      gradientUnits="userSpaceOnUse"
      x1="-588.158"
      y1="-514.559"
      ...
      y2="-483.505"
      gradientTransform="translate(675 599.775)"
    ><stop offset="0" stop-opacity=".15" /><stop offset=".3" stop-opacity=".06" /><stop offset="1" stop-opacity=".03" /></linearGradient><path fill="url(#f)" d="M59.158 125.791l26.063-44.363c-4.112 4.904-9.794 8.233-16.082 9.426l-11.091 34.937" /><linearGradient
      id="g"
      gradientUnits="userSpaceOnUse"
      x1="-588.6"
      y1="-505.621"
  ...
  <svg
    v-else-if="props.name === 'slack'"
    class="maxWidth"
    viewBox="0 0 128 128"
    :aria-label="props.altText"
  >
    <g id="original-slack"><path fill="#80cade" d="M12.81,67.6a10.2,10.2,0,0,1-9.94-7c-.06-.17-.1-.33-.15-.49A10.69,10.69,0,0,1,9.64,47.07L97,17.8a11.82,11.82,0,0,1,3.19-.47,10.47,10.47,0,0,1,10.21,7.14l.13.42c1.63,5.71-2.43,10.81-7.29,12.44L16.36,67a11.3,11.3,0,0,1-3.55.6Z" /><path fill="#db015c" d="M27.37,110.55a10.19,10.19,0,0,1-10-6.89c-.05-.16-.1-.32-.15-.49A10.76,10.76,0,0,1,24.16,90L111.5,60.46a11.24,11.24,0,0,1,3.47-.58A10.55,10.55,0,0,1,125.15,67l.13.44A11.05,11.05,0,0,1,124,76.28c-1.25,1.95-5.19,3.66-5.19,3.66l-87.68,30a12,12,0,0,1-3.71.63Z" /><path fill="#e8a900" d="M100.08,110.74a10.72,10.72,0,0,1-10.27-7.31L60.66,16.84l-.15-.49A10.74,10.74,0,0,1,81,10l29.15,86.58.08.28a10.73,10.73,0,0,1-10.17,13.89Z" /><path fill="#41b088" d="M56.75,125.33A10.73,10.73,0,0,1,46.48,118L17.33,31.43l-.15-.48a10.72,10.72,0,0,1,6.9-13.12,10.89,10.89,0,0,1,3.34-.56,10.72,10.72,0,0,1,10.27,7.31l29.14,86.59c.05.15.1.32.15.48a10.73,10.73,0,0,1-10.23,13.68h0Z" /><path fill="#ca161a" d="M85.71,91.24,106,84.29,99.39,64.56,79,71.44Z" /><path fill="#3b1d37" d="M42.45,106l20.32-6.95L56.08,79.2,35.73,86.08Z" /><path fill="#69852c" d="M71.24,48.26l20.33-6.94L85,21.82,64.64,28.64Z" /><path fill="#118f79" d="M28,63,48.3,56.09,41.65,36.34,21.29,43.16,28,63Z" /></g>
  </svg>
</template>
